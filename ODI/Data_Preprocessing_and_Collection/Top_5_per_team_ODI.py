    ...
    for file in os.listdir(data_dir):
        if file.endswith('.json'):
            with open(os.path.join(data_dir, file)) as f:
                ...
                if (
                    match_data['info'].get('match_type') == 'ODI' and
...
teams_to_include = ['India', 'South Africa', 'New Zealand', 'Australia', 'Nepal', 'United States of America', 'United Arab Emirates', 'West Indies', 'Papua New Guinea', 'Zimbabwe', 'Namibia', 'Sri Lanka', 'England', 'Pakistan', 'Kenya', 'Bangladesh', 'Netherlands', 'Bermuda', 'Ireland', 'Scotland', 'Oman', 'Thailand', 'Hong Kong', 'Canada', 'Asia XI', 'Africa XI', 'Jersey', 'ICC World XI']
...
top_scorers_df.to_csv('top_five_scorers_per_team.csv', index=False)
